<?php 
 ...
 if (isset($_POST['btn-update']))
 {
  ...
  {    
      ...
      if ($count > 0)
      {
         $sql = "UPDATE bloodlist SET name='$name', blood_group='$blood', roll='$roll', gender='$gender', dept='$dept', age='$age', weight='$weight', contact_no='$contact', facebook_id='$fb', present_address='$address' WHERE bloodlist.email_id = '$logMail'"; 
         $result = mysqli_query($conn, $sql);
         $errorType1 = "success";
         $errorMsg1 = "Your information has been updated. Go to user account to view them";
      }
      else
      {
         $sql = "INSERT INTO bloodlist (name, blood_group, roll, gender, dept, age, weight, contact_no, email_id, facebook_id, present_address) VALUES ('$name', '$blood', '$roll', '$gender', '$dept', '$age', '$weight', '$contact', '$logMail', '$fb', '$address')";       
         $result = mysqli_query($conn, $sql);
         $errorType1 = "success";
         $errorMsg1 = "Your information has been inserted. Go to user account to view them";
      }
  }
 }
            ...
            <div class="container">
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
                    ...
                    <div class="col-md-8">
                        ...
                        <?php if ($errorType1 != "") { ?> 
                         <div class="alert alert-<?php echo ($errorType1=="success") ? "success" : $errorType1; ?>">                            
                        ...
                        <div class="form-group">
                            <h2 class="text-center">Register your blood group below</h2>
                            <br/>
                            <p>If you have already registered your blood group, it will be overwritten with information given now.</p>
                        ...
                        <button type="submit" class="btn btn-primary" name="btn-update">Submit</button>
